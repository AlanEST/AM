...
#Centrándonos en las correlaciones entre SO2 y las otras seis variables, vemos que la correlación entre SO2 y precip es muy pequeña y entre SO2 y predías es moderada. Pero los paneles relevantes en el diagrama de dispersión indican que el coeficiente de correlación que evalúa solo la relación lineal entre dos variables puede no ser adecuado aquí y que en un modelo de regresión lineal múltiple para los datos podrían considerarse efectos cuadráticos de predías y precip.
